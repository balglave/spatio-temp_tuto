...
\title[VAST theory]{Introduction to spatio-temporal modelling for environment and ecology}

\author[Baptiste Alglave]{\scriptsize Baptiste Alglave, Maxime Olmos, Etienne Rivot}
